      ...
      <header className="topbar">
        <div>
          ...
          <div className="author-bar">
            <span>{t.madeBy} · <b>王知风</b></span>
            <a className="author-link tools" href="https://wangzhifeng.vip/" target="_blank" rel="noopener noreferrer">🔧 {t.moreTools}</a>
            <a className="author-link tutorial" href="https://wangzhifeng.vip/" target="_blank" rel="noopener noreferrer">📖 {t.tutorial}</a>
          </div>
        </div>
